...
Процедура СоответствуетПредикату() Экспорт
	...
	Объект = Новый Структура("Число, Строка, Дата, Массив", 1, "1", Дата, ЮТОбщий.ЗначениеВМассиве(1, "1"));
...
Процедура КаждыйЭлементСоответствуетПредикату() Экспорт
	...
	Дата = ЮТест.Данные().СлучайнаяДата();
	Объект = Новый Структура("Число, Строка, Дата, Массив", 1, "1", Дата, ЮТОбщий.ЗначениеВМассиве(1, "1"));
	Объект2 = Новый Структура("Число, Строка, Дата, Массив", 1, "1", Дата, ЮТОбщий.ЗначениеВМассиве(1, "1"));
