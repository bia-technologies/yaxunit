...
Процедура ИсполняемыеСценарии() Экспорт
	...
	ЮТТесты
		...
		.ДобавитьСерверныйТест("СформироватьКодДвиженийВФорматеКонструктора_ОдинРегистр")
		.ДобавитьСерверныйТест("СформироватьКодДвиженийВФорматеКонструктора_НесколькоРегистров")
		.ДобавитьСерверныйТест("СформироватьКодДвиженийВФорматеMarkdown_ОдинРегистр")
		.ДобавитьСерверныйТест("СформироватьКодДвиженийВФорматеMarkdown_НесколькоРегистров")
...
Процедура СформироватьКодДвиженийВФорматеКонструктора_ОдинРегистр() Экспорт
	...
	Результат = ЮТГенераторКодаСлужебныйСервер.СформироватьКодДвиженийВФорматеКонструктора(Документ, ДанныеДвижений);
...
Процедура СформироватьКодДвиженийВФорматеКонструктора_НесколькоРегистров() Экспорт
...
Процедура СформироватьКодДвиженийВФорматеMarkdown_ОдинРегистр() Экспорт
	...
	Результат = ЮТГенераторКодаСлужебныйСервер.СформироватьКодДвиженийВФорматеMarkdown(Документ, ДанныеДвижений);
...
Процедура СформироватьКодДвиженийВФорматеMarkdown_НесколькоРегистров() Экспорт
...
Процедура СформироватьКодПоСсылкамНаОбъекты_ОдинСправочник() Экспорт
	...
	СсылкиНаОбъекты = Новый Массив;
	СсылкиНаОбъекты.Добавить(Справочник);
	...
	ЮТест.ОжидаетЧто(Результат)
		.ИмеетТип("Строка")
		.Заполнено()
		.Содержит("// Создание Справочник.Товары")
		.Содержит("ТоварыСсылка = ЮТест.Данные().КонструкторОбъекта(""Справочник.Товары"")")
...
Процедура СформироватьКодПоСсылкамНаОбъекты_ОдинДокумент() Экспорт
	...
	СсылкиНаОбъекты = Новый Массив;
	СсылкиНаОбъекты.Добавить(Документ);
	...
	ЮТест.ОжидаетЧто(Результат)
		.ИмеетТип("Строка")
		.Заполнено()
		.Содержит("// Создание Документ.УстановкаЦен")
		.Содержит("УстановкаЦенСсылка = ЮТест.Данные().КонструкторОбъекта(""Документ.УстановкаЦен"")")
		.Содержит(".Установить(""Номер"",")
		.Содержит(НомерДокумента)
