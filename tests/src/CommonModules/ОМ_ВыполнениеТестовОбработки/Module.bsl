...
Процедура ИсполняемыеСценарииОбработки() Экспорт
...
Процедура ВыполнитьТестыОбработки() Экспорт
...
Функция Обработка()
	...
	ИмяФайлаОбработки = ЮТВнешниеОбработкиСлужебныйСервер.СкомпилирватьВнешнуюОбработку(Текст);
