...
Процедура ИсполняемыеСценарии() Экспорт
	...
	ЮТТесты
		.СвойствоОтчета("Свойство модуля", "1")
		...
		.ДобавитьТест("СвойствоОтчета_УстановленныеСвойства")
			.СвойствоОтчета("Свойство теста", "2")
...
Процедура СвойствоОтчета_Тест() Экспорт
	...
	СвойстваОтчета = ЮТФабрикаСлужебный.СвойстваAllure();
...
Процедура СвойствоОтчета_УстановленныеСвойства() Экспорт
	
	ЮТест.ОжидаетЧто(ЮТест.ОписаниеТекущегоТестовогоМодуля(), "Модуль")
		.Свойство("СвойстваОтчета")
			.ИмеетСвойство("Свойство модуля")
	;
	
	ЮТест.ОжидаетЧто(ЮТест.ОписаниеТекущегоТеста(), "Тест")
		.Свойство("СвойстваОтчета")
			.ИмеетСвойство("Свойство теста")
	;
КонецПроцедуры
...
Процедура СвойствоАлюр_Тест() Экспорт
	ЮТАлюр
		...
		.Описание("Проверка установки свойств allure")
		.Свойство("Произвольное свойство", "Произвольное свойство");
	
	ЮТест.ОжидаетЧто(ЮТест.ОписаниеТекущегоТеста())
		.Свойство("СвойстваAllure")
			.ИмеетДлину(3)
			.ИмеетСвойство("severity")
			.ИмеетСвойство("description")
