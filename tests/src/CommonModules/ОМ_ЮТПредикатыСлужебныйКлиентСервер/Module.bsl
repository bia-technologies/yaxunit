...
Процедура ЭтоПредикат() Экспорт
	...
	Варианты = ЮТест.Варианты("Предикаты, ОжидаемоеЗначение")
		...
		.Добавить(ЮТКоллекции.ЗначениеВМассиве(СтруктураПредикат), Истина)
		.Добавить(СтруктураПредикат, Истина)
		.Добавить(ЮТКоллекции.ЗначениеВМассиве(Новый Структура), Ложь)
		.Добавить(ЮТКоллекции.ЗначениеВМассиве(Новый Структура("ЛюбойПараметр", 1)), Ложь)
		.Добавить(ЮТКоллекции.ЗначениеВМассиве(1, 2, 3), Ложь);
