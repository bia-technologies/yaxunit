...
Процедура ИсполняемыеСценарии() Экспорт
	...
	ЮТТесты.ЗависитОт().ФайлыПроекта(".gitignore")
		...
		.ДобавитьТест("ДанныеЗависимости")
...
Процедура ДанныеЗависимости() Экспорт
	...
	ЮТест.ОжидаетЧто(ЮТФайлы.Существует(ПолноеИмяФайла), "Файл каталога проекта не сущесвует")
		.ЭтоИстина();
	
	Данные = ЮТОбщий.ДанныеТекстовогоФайла(ПолноеИмяФайла);
	ЮТест.ОжидаетЧто(Данные, "Содержимое файла")
		.Содержит("/src/Configuration/ConfigDumpInfo.xml");
	
КонецПроцедуры

Процедура ДанныеЗависимости_НеизвестныйФайл() Экспорт
	
	ПолноеИмяФайла = ЮТест.Зависимость(ЮТЗависимости.ФайлыПроекта("НеизвестныйФайл")).ПолноеИмя;
