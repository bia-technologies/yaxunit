...
* [Проверка прав](verification-roles.md)
* [Запись справочников](write-catalogs.md)
...
```json title="Дымовые тесты.json"
{
    ...
    "ДымовыеТесты": {
        ...
        "ПроверкаПрав": {
            "Использовать": true, // Использование тестов проверки прав
            "ИнтерактивноеУдаление": true,
            "ИнтерактивноеУдалениеПомеченных": true,
            "ЧтениеНеАдминистраторами": true
        },
        "ЗаписьСправочников": {
            "Использовать": true, // Использование тестов записи справочников
            "Элементы": true, // проверять запись элементов справочников
            "Группы": true, // проверять запись групп иерархических справочников
        }
    }
}
```
...
| `ПроверкаПрав`         | `Object\|boolean` | `true`                | [Настройка тестов проверки прав](verification-roles.md#настройки)       |
| `ЗаписьСправочников`   | `Object\|boolean` | `true`                | [Настройка записи справочников](write-catalogs.md#настройки)            |
