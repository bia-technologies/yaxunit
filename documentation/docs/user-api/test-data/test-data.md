...
| Товар 2 | Поставщик       | Товар     | 200  | 1          | 200   |
| Услуга  |                 | Услуга    | 300  | 1          | 300   |
...
ОжидаемоеЗначение = ТабличныйДокумент.ПолучитьОбласть(8, 1, 11, 4);
...
```bsl
ДанныеТоваров = ТабличныйДокумент.ПолучитьОбласть(2, 1, 5, 9);
ДанныеДокументов = ТабличныйДокумент.ПолучитьОбласть(7, 1, 8, 9);
ОжидаемыеДвижения = ТабличныйДокумент.ПолучитьОбласть(10, 1, 15, 10);
