...
Подробнее ознакомиться с функциональностью вы можете изучив [документацию](/docs/features).

А для того, что бы начать писать тесты необходимо [установить расширение](/docs/getting-started/install) в свою IDE (конфигуратор или EDT).
...
1. Сформировать файл конфигурации запуска [вручную](/docs/getting-started/run), либо воспользоваться [формой настройки](/docs/yaxunit-ui)
2. [Запустить 1С:Предприятие](/docs/getting-started/run) с параметром `RunUnitTests=ПутьКФайлуКонфигурации.json`.
