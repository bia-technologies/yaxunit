...
//	КонецЕсли;
	...
	ВладельцыФорм = ЮТДымовыеТесты.Формы(КоллекцииМетаданных, ОтборМетаданных(Настройки));
	...
	Для Каждого ВладелецФорм Из ВладельцыФорм Цикл
		...
		Формы = ВладелецФорм.Формы;
		ВладелецФорм.Удалить("Формы");
		
		Для Каждого ОписаниеФормы Из Формы Цикл
			
			ЗарегистрироватьТестыФормы(ВладелецФорм, ОписаниеФормы, Настройки);
...
Процедура ОткрытьФорму_Новый(ОписаниеФормы) Экспорт
	...
	ОткрытьЗакрытьФорму(ОписаниеФормы.Владелец, ОписаниеФормы.ТипФормы);
	
КонецПроцедуры

Процедура ОткрытьФорму_Существующий(ОписаниеФормы) Экспорт
	
	ОбъектМетаданных = ОписаниеФормы.Владелец;
	Параметры = Новый Структура("Отбор", Новый Структура("ЭтоГруппа", ОписаниеФормы.ЭтоФормаГруппы));
	
	Ключ = ЮТДымовыеТесты.СлучайныйЭлемент(ОбъектМетаданных.Тип, ОбъектМетаданных.Имя, Параметры);
	...
	ОткрытьЗакрытьФорму(ОбъектМетаданных, ОписаниеФормы.ТипФормы, Ключ);
	
КонецПроцедуры

Процедура ОткрытьФорму_Скопированный(ОписаниеФормы) Экспорт
	...
	ОткрытьЗакрытьФорму(ОбъектМетаданных, ОписаниеФормы.ТипФормы);
	
КонецПроцедуры

Процедура ОткрытьФорму_Выбор(ОписаниеФормы) Экспорт
	
	ОткрытьЗакрытьФорму(ОписаниеФормы.Владелец, ОписаниеФормы.ТипФормы);
	
КонецПроцедуры

Процедура ОткрытьФорму_ВыборГруппы(ОписаниеФормы) Экспорт
	
	ОткрытьЗакрытьФорму(ОписаниеФормы.Владелец, ОписаниеФормы.ТипФормы);
	
КонецПроцедуры

Процедура ОткрытьФорму_Список(ОписаниеФормы) Экспорт
