...
// Добавляет запись в набор данных, которые можно будет прочитать из RecordSet
// 
// Параметры:
...
// Возвращает значение, которое показывает, находится ли текущее положение записи курсора перед первой записью
// 
// Возвращаемое значение:
//  Булево
Функция BOF() Экспорт
