...
Процедура СформироватьТекстНаСервере()
	...
	ПараметрыГенерацииКода.ИспользоватьНастройкуПостоянныеДанные = НастройкиРежимУстановкиРеквизитов = Режимы.Авто;
...
Процедура ОбновитьОписаниеРежимаУстановкиРеквизитов()
	...
	Если НастройкиРежимУстановкиРеквизитов = Режимы.Авто Тогда
		Описание = "Автоматический режим. Для типов указанных в ЮТТестовыеДанныеПереопределяемый.ПостоянныеДанные выполняется поиск, для прочих создание";
