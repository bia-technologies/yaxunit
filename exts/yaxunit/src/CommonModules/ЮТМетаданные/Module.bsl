...
// 
// Параметры:
//  ИмяТаблицы - Строка, Менеджер - Таблица информационной базы (объет метаданных)
...
Функция ТипыРеквизитов(ИмяТаблицы, ВСоответствие = Ложь) Экспорт
	...
	Иначе
		ВызватьИсключение "Некорректное имя таблицы (объекта метаданных) - " + ИмяТаблицы;
	КонецЕсли;
