...
Процедура ДобавитьОбщиеРеквизиты(МетаданныеОбъекта, КоллекцияОписаний)
	...
	Для Каждого Реквизит Из Метаданные.ОбщиеРеквизиты Цикл
		...
		Если ЭлементСостава = Неопределено Тогда
			Продолжить;
		ИначеЕсли Реквизит.РазделениеДанных = Разделять И Реквизит.УсловноеРазделение <> Неопределено И Не Константы[Реквизит.УсловноеРазделение.Имя].Получить() Тогда
			Продолжить;
