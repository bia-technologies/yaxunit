...
// Поле основного представления.
// 
// Параметры:
//  Объект - ОбъектМетаданныхСправочник
// 
// Возвращаемое значение:
// 	Строка
//  
Функция ПолеОсновногоПредставленияСправочника(Объект) Экспорт
	
	Если Объект.ОсновноеПредставление = Метаданные.СвойстваОбъектов.ОсновноеПредставлениеСправочника.ВВидеНаименования
		И Объект.ДлинаНаименования > 0 Тогда
		Возврат "Наименование";
	ИначеЕсли Объект.ОсновноеПредставление = Метаданные.СвойстваОбъектов.ОсновноеПредставлениеСправочника.ВВидеКода
		И Объект.ДлинаКода > 0 Тогда 
		Возврат "Код";
	Иначе
		Возврат "";
	КонецЕсли;
...
Процедура ДобавитьОбщиеРеквизиты(МетаданныеОбъекта, КоллекцияОписаний)
	...
	Для Каждого Реквизит Из Метаданные.ОбщиеРеквизиты Цикл
		...
		Если ЭлементСостава = Неопределено Тогда
			Продолжить;
		ИначеЕсли ОбщийРеквизитОтключенУсловнымРазделением(Реквизит) Тогда
			Продолжить;
...
Функция ОбщийРеквизитОтключенУсловнымРазделением(Реквизит)
	
	Возврат Реквизит.РазделениеДанных = Метаданные.СвойстваОбъектов.РазделениеДанныхОбщегоРеквизита.Разделять
		И Реквизит.УсловноеРазделение <> Неопределено
			И Не ЗначениеКонстантыРазделителя(Реквизит.УсловноеРазделение.Имя);
			
КонецФункции

Функция ЗначениеКонстантыРазделителя(ИмяКонстанты)
