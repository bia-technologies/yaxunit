...
Функция СкомпилироватьВнешнююОбработку(ТекстМодуляОбъект = "", Знач ТекстМодуляОбычнойФормы = "", Знач ТекстМодуляУправляемойФормы = "") Экспорт
	...
	ТекстМодуляУправляемойФормы = ТекстМодуляФормы(ТекстМодуляУправляемойФормы);
...
Функция ТекстМодуляФормы(ОсновнойТекст)
	
	ТекстМодуляУправляемойФормы = СтрЗаменить(ОсновнойТекст, """", """""");
	
	ТекстМодуляУправляемойФормы = СтрЗаменить(ТекстМодуляУправляемойФормы, "Процедура ", "&НаКлиенте Процедура ");
	ТекстМодуляУправляемойФормы = СтрЗаменить(ТекстМодуляУправляемойФормы, "Функция ", "&НаКлиенте Функция ");
	
	Возврат ТекстМодуляУправляемойФормы;
