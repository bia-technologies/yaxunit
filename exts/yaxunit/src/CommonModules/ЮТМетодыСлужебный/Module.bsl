...
Функция МетодМодуляСуществует(ИмяМодуля, ИмяМетода, Кешировать = Истина) Экспорт
	...
	Ошибка = ВыполнитьВыражение(Алгоритм);
...
#Иначе
	...
	Ошибка = ВыполнитьВыражение(Алгоритм, , Объект);
...
Функция ВыполнитьМетодОбъекта(Объект, ИмяМетода, Параметры = Неопределено) Экспорт
	
	Выражение = "Объект." + СтрокаВызоваМетода(ИмяМетода, Параметры, "Параметры");
	Возврат ВыполнитьВыражение(Выражение, Параметры, Объект, Ложь);
	
КонецФункции

Функция ВыполнитьМетодКонфигурации(ИмяМодуля, ИмяМетода, Параметры = Неопределено) Экспорт
	...
	Возврат ВыполнитьВыражение(Выражение, Параметры, , Ложь);
...
Функция ВыполнитьВыражение(Выражение, Параметры = Неопределено, Объект = Неопределено, Безопасно = Истина)
