...
//  ПараметрыДвижка - см. ЮТФабрика.ПараметрыДвижка
Процедура ИнициализироватьКонтекст(ПараметрыЗапуска, ПараметрыДвижка) Экспорт
	
#Если НЕ Клиент Тогда
	ВызватьИсключение "Метод `ИнициализироватьКонтекст` должен вызываться только с клиента";
#Иначе
	ЮТКонтекстСлужебныйКлиент.ИнициализироватьКонтекст(ПараметрыЗапуска, ПараметрыДвижка);
	ЮТКонтекстСлужебныйВызовСервера.ИнициализироватьКонтекст(ПараметрыЗапуска, ПараметрыДвижка);
...
// см. ЮТФабрика.ПараметрыДвижка
Функция ПараметрыДвижка() Экспорт
	
	Возврат ЗначениеКонтекста(ИмяКонтекстаПараметрыДвижка());
	
КонецФункции

Функция ОписаниеКонтекста(ПараметрыЗапуска, ПараметрыДвижка) Экспорт
	
	Описание = Новый Структура;
	Описание.Вставить(ИмяКонтекстаПараметрыДвижка(), ПараметрыДвижка);
...
Функция ИмяКонтекстаПараметрыДвижка()
	
	Возврат "КонтекстПараметрыДвижка";
