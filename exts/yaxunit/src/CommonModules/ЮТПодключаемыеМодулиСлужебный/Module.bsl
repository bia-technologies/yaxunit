...
Функция МодулиНастройкиКодогенерации() Экспорт
	
	Возврат МодулиПодсистемы("Кодогенерация", Истина, Ложь);
...
Функция ИменаМодулейНастройкиКодогенерация() Экспорт
	
	Возврат ЮТПодключаемыеМодулиСлужебныйВызовСервера.ПодключаемыеМодулиПодсистемы("Кодогенерация", Истина);
