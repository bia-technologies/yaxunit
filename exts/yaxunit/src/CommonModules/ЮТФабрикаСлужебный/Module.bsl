...
// * СвойстваОтчета - Структура - Дополнительные свойства отчета
...
Функция БазовоеОписаниеРегистрируемогоОбъекта()
	...
	Описание.Вставить("СвойстваОтчета", Новый Структура);
...
Процедура ЗаполнитьБазовоеОписаниеИсполняемогоОбъекта(ИсполняемыйОбъект, РегистрируемыйОбъекта)
	...
	ИсполняемыйОбъект.СвойстваОтчета = ЮТКоллекции.СкопироватьСтруктуру(РегистрируемыйОбъекта.СвойстваОтчета);
