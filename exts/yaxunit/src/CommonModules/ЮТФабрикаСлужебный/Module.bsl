...
// * СвойстваОтчета - Соответствие из Строка - Дополнительные свойства отчета
// * СвойстваAllure - Соответствие из Строка - Дополнительные свойства отчета Allure
...
Процедура ЗаполнитьБазовоеОписаниеИсполняемогоОбъекта(ИсполняемыйОбъект, РегистрируемыйОбъекта)
	
	ИсполняемыйОбъект.Теги = ЮТКоллекции.СкопироватьМассив(РегистрируемыйОбъекта.Теги);
	
	ИсполняемыйОбъект.НастройкиВыполнения = ЮТКоллекции.СкопироватьСтруктуру(РегистрируемыйОбъекта.НастройкиВыполнения);
	ИсполняемыйОбъект.Зависимости = ЮТКоллекции.СкопироватьМассив(РегистрируемыйОбъекта.Зависимости);
	
	ИсполняемыйОбъект.Ошибки = ЮТКоллекции.СкопироватьМассив(РегистрируемыйОбъекта.Ошибки);
	ИсполняемыйОбъект.СвойстваОтчета = ЮТКоллекции.СкопироватьСоответствие(РегистрируемыйОбъекта.СвойстваОтчета);
	ИсполняемыйОбъект.СвойстваAllure = ЮТКоллекции.СкопироватьСоответствие(РегистрируемыйОбъекта.СвойстваAllure);
