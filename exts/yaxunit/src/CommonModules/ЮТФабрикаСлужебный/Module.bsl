...
Процедура ЗаполнитьБазовоеОписаниеИсполняемогоОбъекта(ИсполняемыйОбъект, РегистрируемыйОбъекта)
	...
	Если РегистрируемыйОбъекта.Свойство("СвойстваОтчета") Тогда
		ИсполняемыйОбъект.Вставить("СвойстваОтчета", ЮТКоллекции.СкопироватьСоответствие(РегистрируемыйОбъекта.СвойстваОтчета));
	КонецЕсли;
	Если РегистрируемыйОбъекта.Свойство("СвойстваAllure") Тогда
		ИсполняемыйОбъект.Вставить("СвойстваAllure", ЮТКоллекции.СкопироватьСоответствие(РегистрируемыйОбъекта.СвойстваAllure));
	КонецЕсли;
