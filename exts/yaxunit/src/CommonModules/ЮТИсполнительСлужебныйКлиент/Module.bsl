...
Процедура ОбработчикЗагрузитьТестыВнешнейОбработки(_, ПараметрыИсполнения) Экспорт
	...
	Если ПараметрыИсполнения.ОписаниеМодуля.Сервер Тогда
		Сценарции = ЮТИсполнительСлужебныйВызовСервера.СценарииВнешнейОбработки(ПараметрыИсполнения.ИмяВнешнейОбработки);
		ТестовыеМодули.Добавить(Сценарции);
	ИначеЕсли ПараметрыИсполнения.ОписаниеМодуля.КлиентОбычное Или ПараметрыИсполнения.ОписаниеМодуля.КлиентУправляемое Тогда
		Сценарции = ЮТИсполнительСлужебныйКлиентСервер.СценарииВнешнейОбработки(ПараметрыИсполнения.ИмяВнешнейОбработки);
		ТестовыеМодули.Добавить(Сценарции);
	КонецЕсли;
