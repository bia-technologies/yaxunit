...
// 
// Параметры:
//  Параметр1 - Массив из Произвольный - Доступные значения для первого параметры
//  Параметр2 - Массив из Произвольный - Доступные значения для второго параметры
//  Параметр3 - Массив из Произвольный - Доступные значения для третьего параметры
//  Параметр4 - Массив из Произвольный - Доступные значения для четвертого параметры
//  Параметр5 - Массив из Произвольный - Доступные значения для пятого параметры
//  Параметр6 - Массив из Произвольный - Доступные значения для шестого параметры
//  Параметр7 - Массив из Произвольный - Доступные значения для седьмого параметры
// 
// Возвращаемое значение:
//  ОбщийМодуль - Этот же модуль, для замыкания
// Примеры:
...
//    { "Р1: 3, Р2": 13 }]
//@skip-check method-too-many-params
Функция ДобавитьКомбинации(Параметр1, // BSLLS:NumberOfOptionalParams-off
				 Параметр2 = Неопределено,
				 Параметр3 = Неопределено,
				 Параметр4 = Неопределено,
				 Параметр5 = Неопределено,
