...
Функция СоздатьДокумент(Менеджер, Реквизиты = Неопределено, ДанныеТабличныхЧастей = Неопределено) Экспорт
	
	Возврат ЮТТестовыеДанныеВызовСервера.СоздатьДокумент(Менеджер, Реквизиты, ДанныеТабличныхЧастей);
