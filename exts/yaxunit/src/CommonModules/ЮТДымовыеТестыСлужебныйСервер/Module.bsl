...
Функция Формы(КоллекцииМетаданных, ОтборМетаданных) Экспорт
	...
	Для Каждого ИмяКоллекции Из КоллекцииМетаданных Цикл
		...
		Для Каждого ОбъектМетаданных Из Коллекция Цикл
			...
			ВладелецФорм.Вставить("Просмотр", ПравоДоступа("Просмотр", ОбъектМетаданных));
			ВладелецФорм.Вставить("Редактирование", ПравоДоступа("Редактирование", ОбъектМетаданных));
			ВладелецФорм.Вставить("ИнтерактивноеДобавление", ПравоДоступа("ИнтерактивноеДобавление", ОбъектМетаданных));
