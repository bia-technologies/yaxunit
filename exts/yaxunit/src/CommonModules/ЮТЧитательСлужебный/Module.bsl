...
Функция ИсполняемыеСценарииМодуля(Знач МетаданныеМодуля) Экспорт
	...
	Ошибка = ЮТМетодыСлужебный.ВыполнитьМетодКонфигурации(ПолноеИмяМетода, Неопределено);
	...
	Если Ошибка <> Неопределено Тогда
		...
		ИначеЕсли ТипОшибки = ТипыОшибок.МалоПараметров Тогда
			Ошибка = ЮТМетодыСлужебный.ВыполнитьМетодКонфигурации(ПолноеИмяМетода, Неопределено, ЮТКоллекции.ЗначениеВМассиве(Неопределено));
