...
//     .ЗависитОт()
//     .ФайлыПроекта("fixtures/data.json")  // Зависимость от файла проекта
//     .ФабрикаXDTO("fixtures/schemas");     // Зависимость от фабрики XDTO
//
...
// Устанавливает свойство Allure для текущего теста, набора тестов или модуля.
// Свойство будет установлено для того объекта, в контексте которого вызван метод.
// 
// Параметры:
//  КлючСвойства - Строка - Ключ свойства
...
//
// Пример:
// ЮТТесты.ДобавитьТест("ТестСАлюр")
//     .СвойствоАлюр(ЮТАлюр.Epic, "Документы")
//     .СвойствоАлюр("feature", "Проведение");
//
Функция СвойствоАлюр(КлючСвойства, ЗначениеСвойства) Экспорт
	
	ЮТТестыСлужебный.СвойствоАлюр(КлючСвойства, ЗначениеСвойства);
	Возврат ЮТТесты;
...
// Устанавливает набор свойств Allure для текущего теста, набора тестов или модуля.
// Свойства будут установлены для того объекта, в контексте которого вызван метод.
// 
// Параметры:
//  СтруктураСвойств - Структура - Структура свойств, где ключ - имя свойства, значение - значение свойства
...
//
// Пример:
// ЮТТесты.ДобавитьТест("ТестСоСвойствамиАлюр")
//     .СвойстваАлюр(Новый Структура("epic,feature,severity", "Документы,Проведение,critical"))
//     .Тег("Алюр");
//
Функция СвойстваАлюр(СтруктураСвойств) Экспорт
	
	ЮТТестыСлужебный.СвойстваAllure(СтруктураСвойств);
	Возврат ЮТТесты;
