...
Функция НастройкаПараметровДвижка() Экспорт
	
	ПараметрыДвижка = ЮТФабрика.ПараметрыДвижка();
	Параметры = ЮТКоллекции.ЗначениеВМассиве(ПараметрыДвижка);
	ВызватьПодключаемыйОбработчикСобытия("НастройкаПараметровДвижка", "Инициализация", Параметры);
	
	Возврат Новый ФиксированнаяСтруктура(ПараметрыДвижка);
