...
// ЮТПредикаты.Реквизит("Код").Равно("123");
//
// // Проверка элемента массива по индексу
// ЮТПредикаты.Реквизит(0).Равно("Первый");
...
// ЮТПредикаты.Реквизит("Наименование").Равно("Товар");
//
// // Проверка на равенство числа
// ЮТПредикаты.Реквизит("Количество").Равно(10);
//
// // Проверка на равенство даты
// ЮТПредикаты.Реквизит("Дата").Равно(ТекущаяДата());
...
// ЮТПредикаты.Реквизит("Наименование").НеРавно("Товар");
//
// // Проверка на неравенство числа
// ЮТПредикаты.Реквизит("Количество").НеРавно(0);
...
// ЮТПредикаты.Реквизит("Наименование").Заполнено();
//
// // Проверка заполненности элемента массива
// ЮТПредикаты.Реквизит(0).Заполнено();
...
// ЮТПредикаты.Реквизит("Комментарий").НеЗаполнено();
//
// // Проверка пустоты элемента массива
// ЮТПредикаты.Реквизит(0).НеЗаполнено();
...
// Пример:
// // Проверка пустоты реквизита
// ЮТПредикаты.Реквизит("Комментарий").Пусто();
//
// // Проверка пустоты элемента массива
// ЮТПредикаты.Реквизит(0).Пусто();
...
// ЮТПредикаты.Реквизит("Количество").Больше(0);
//
// // Проверка, что дата больше
// ЮТПредикаты.Реквизит("Дата").Больше(ДобавитьКДате(ТекущаяДата(), "ДЕНЬ", -1));
...
// ЮТПредикаты.Реквизит("Количество").БольшеИлиРавно(0);
//
// // Проверка, что дата больше или равна
// ЮТПредикаты.Реквизит("Дата").БольшеИлиРавно(ТекущаяДата());
...
// ЮТПредикаты.Реквизит("Количество").Меньше(100);
//
// // Проверка, что дата меньше
// ЮТПредикаты.Реквизит("Дата").Меньше(ТекущаяДата());
...
// ЮТПредикаты.Реквизит("Количество").МеньшеИлиРавно(100);
//
// // Проверка, что дата меньше или равна
// ЮТПредикаты.Реквизит("Дата").МеньшеИлиРавно(ТекущаяДата());
...
// ЮТПредикаты.Реквизит("Значение").ИмеетТип("Строка");
//
// // Проверка типа по типу
// ЮТПредикаты.Реквизит("Дата").ИмеетТип(Тип("Дата"));
//
// // Проверка типа по описанию типов
// ЮТПредикаты.Реквизит("Сумма").ИмеетТип(Новый ОписаниеТипов("Число"));
...
// ЮТПредикаты.Реквизит("Значение").ИмеетТипОтличныйОт("Строка");
//
// // Проверка, что значение не число
// ЮТПредикаты.Реквизит("Сумма").ИмеетТипОтличныйОт(Тип("Число"));
...
// ЮТПредикаты.Реквизит("Наименование").ИмеетДлину(10);
//
// // Проверка размера массива
// ЮТПредикаты.Реквизит("Элементы").ИмеетДлину(5);
//
// // Проверка количества записей в таблице
// ЮТПредикаты.Реквизит("Товары").ИмеетДлину(100);
...
// ЮТПредикаты.Реквизит("Наименование").ИмеетДлинуОтличнуюОт(0);
//
// // Проверка, что размер массива не равен
// ЮТПредикаты.Реквизит("Элементы").ИмеетДлинуОтличнуюОт(1);
...
// ЮТПредикаты.Реквизит("Данные").ИмеетСвойство("Код");
//
// // Проверка наличия элемента в массиве по индексу
// ЮТПредикаты.Реквизит("Массив").ИмеетСвойство(0);
//
// // Проверка наличия значения в соответствии по ключу
// ЮТПредикаты.Реквизит("Соответствие").ИмеетСвойство("Ключ");
...
// ЮТПредикаты.Реквизит("Данные").НеИмеетСвойства("Код");
//
// // Проверка отсутствия элемента в массиве
// ЮТПредикаты.Реквизит("Массив").НеИмеетСвойства(10);
...
// ЮТПредикаты.Реквизит("Наименование").Содержит("Товар");
//
// // Проверка наличия элемента в массиве
// ЮТПредикаты.Реквизит("Элементы").Содержит("ИскомыйЭлемент");
...
// ЮТПредикаты.Реквизит("Наименование").НеСодержит("ЗапрещенноеСлово");
//
// // Проверка отсутствия элемента в массиве
// ЮТПредикаты.Реквизит("Элементы").НеСодержит("НежелательныйЭлемент");
...
// ЮТПредикаты.Реквизит("Код").СодержитСтрокуПоШаблону("\d{6}");
//
// // Проверка формата даты
// ЮТПредикаты.Реквизит("ДатаСтрокой").СодержитСтрокуПоШаблону("\d{2}\.\d{2}\.\d{4}");
...
// ЮТПредикаты.Реквизит("Код").НеСодержитСтрокуПоШаблону("[А-Я]");
//
// // Проверка формата даты
// ЮТПредикаты.Реквизит("ДатаСтрокой").НеСодержитСтрокуПоШаблону("\d{2}-\d{2}-\d{4}");
...
// ЮТПредикаты.Реквизит("Статус").ВСписке(ЮТКоллекции.ЗначениеВМассиве("Новый", "ВРаботе", "Завершен"));
//
// // Проверка вхождения в список значений
// СписокСтатусов = Новый СписокЗначений;
// СписокСтатусов.Добавить("Новый");
// СписокСтатусов.Добавить("ВРаботе");
// ЮТПредикаты.Реквизит("Статус").ВСписке(СписокСтатусов);
...
// ЮТПредикаты.Реквизит("Количество").Между(0, 100);
