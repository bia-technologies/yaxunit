...
Процедура СоздатьСсылки(ОписаниеОбъектаМетаданных, ОбщиеРеквизиты, Данные, ПараметрыЗаписи)
	...
	Для Каждого Строка Из Данные Цикл
		...
		Объект = НовыйЗаполненныйОбъект(Менеджер, ОписаниеОбъектаМетаданных, Строка, ОбщиеРеквизиты, ПараметрыЗаписи.ДополнительныеСвойства, УникальныйИдентификаторСсылки);
		ЗаписатьОбъект(Объект, ПараметрыЗаписи);
	КонецЦикла;
