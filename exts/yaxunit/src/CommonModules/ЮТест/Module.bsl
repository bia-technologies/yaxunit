...
Функция ОжидаетЧтоКоллекция(Коллекция, Сообщение = "") Экспорт
	
	Возврат ЮТУтвержденияКоллекция.Что(Коллекция, Сообщение)
	
КонецФункции

Функция ОжидаетЧтоДвижения(Документ, ИмяРегистра, Сообщение = "") Экспорт
	
	Движения = ЮТЗапросы.ДвиженияДокумента(Документ, ИмяРегистра);
	
	Возврат ЮТУтвержденияКоллекция.Что(Движения, Сообщение, "проверяемые движения документа по регистру " + ИмяРегистра);
