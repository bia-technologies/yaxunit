...
// Пытается преобразовать в JSON, если не удалось - использует стандартное преобразование в строку.
//
// Параметры:
//  Значение - Произвольный - Значение для преобразования.
//
...
//  ИмяПоляЗначения - Строка - (необязательный) Имя поля элемента коллекции, значение которого будет использовано в качестве значения в результирующей Структуре.
