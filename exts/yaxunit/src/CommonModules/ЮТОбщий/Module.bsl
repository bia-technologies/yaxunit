...
Функция ЗначениеСтруктуры(ИсходнаяСтруктура, ИмяПоля, ЗначениеПоУмолчанию = Неопределено) Экспорт
	...
	ВызовУстаревшегоМетода("ЮТОбщий.ЗначениеСтруктуры", "ЮТКоллекции.ЗначениеСтруктуры");
...
Функция ОбъединитьВСтруктуру(Знач Коллекция1, Коллекция2) Экспорт
	...
	ВызовУстаревшегоМетода("ЮТОбщий.ОбъединитьВСтруктуру", "ЮТКоллекции.ДополнитьСтруктуру");
...
Функция СкопироватьРекурсивно(Источник) Экспорт
	...
	ВызовУстаревшегоМетода("ЮТОбщий.СкопироватьРекурсивно", "ЮТКоллекции.СкопироватьРекурсивно");
...
Функция СкопироватьСтруктуру(Источник) Экспорт
	...
	ВызовУстаревшегоМетода("ЮТОбщий.СкопироватьСтруктуру", "ЮТКоллекции.СкопироватьСтруктуру");
...
Функция СкопироватьСоответствие(Источник) Экспорт
	...
	ВызовУстаревшегоМетода("ЮТОбщий.СкопироватьСоответствие", "ЮТКоллекции.СкопироватьСоответствие");
...
Функция СкопироватьМассив(Источник) Экспорт
	...
	ВызовУстаревшегоМетода("ЮТОбщий.СкопироватьМассив", "ЮТКоллекции.СкопироватьМассив");
...
Функция СкопироватьСписокЗначений(Источник) Экспорт
	...
	ВызовУстаревшегоМетода("ЮТОбщий.СкопироватьСписокЗначений", "ЮТКоллекции.СкопироватьСписокЗначений");
...
Функция ВыгрузитьЗначения(Коллекция, ИмяРеквизита) Экспорт
	...
	ВызовУстаревшегоМетода("ЮТОбщий.ВыгрузитьЗначения", "ЮТКоллекции.ВыгрузитьЗначения");
...
Функция ПересечениеМассивов(Коллекция1, Коллекция2) Экспорт
	...
	ВызовУстаревшегоМетода("ЮТОбщий.ПересечениеМассивов", "ЮТКоллекции.ПересечениеМассивов");
...
Процедура ДополнитьМассив(Приемник, Источник) Экспорт
	...
	ВызовУстаревшегоМетода("ЮТОбщий.ДополнитьМассив", "ЮТКоллекции.ДополнитьМассив");
...
Функция ВСоответствие(Коллекция, ИмяПоляКлюча, ИмяПоляЗначения = Неопределено) Экспорт
	...
	ВызовУстаревшегоМетода("ЮТОбщий.ВСоответствие", "ЮТКоллекции.ВСоответствие");
...
Функция ВСтруктуру(Коллекция, ИмяПоляКлюча, ИмяПоляЗначения = Неопределено) Экспорт
	...
	ВызовУстаревшегоМетода("ЮТОбщий.ВСтруктуру", "ЮТКоллекции.ВСтруктуру");
	Возврат ЮТКоллекции.ВСтруктуру(Коллекция, ИмяПоляКлюча, ИмяПоляЗначения);
	
КонецФункции

// см. ЮТСравнениеКлиентСервер.ЗначенияРавны
// Устарела Метод перенесен в см. ЮТСравнениеКлиентСервер.ЗначенияРавны
//@skip-check doc-comment-export-function-return-section
//@skip-check doc-comment-parameter-section
Функция ДанныеСовпадают(Данные1, Данные2) Экспорт
	
	ВызовУстаревшегоМетода("ЮТОбщий.ДанныеСовпадают", "ЮТСравнениеКлиентСервер.ЗначенияРавны", Истина);
...
Процедура ВызовУстаревшегоМетода(УстаревшийМетод, РекомендуемыйМетод = Неопределено, ВыбрасыватьИсключения = Ложь) Экспорт
