...
Функция ТестовыеМодули()
	...
	Ключи = Новый Структура("ТестовыеМодули, ТестовыеМодулиЗагружены, ТекущийМодуль",
							"ТестовыеМодули", "ТестовыеМодулиЗагружены", "ТекущийМодуль");
...
Функция ОтфильтрованныеМодули()
	...
	КлючОтфильтрованныеМодули = "ОтфильтрованныеМодули";
	...
	ОтфильтрованныеМодули = ЮТИсполнительСлужебныйКлиент.ЗначениеСостоянияТекущегоЭтапаИсполнения(КлючОтфильтрованныеМодули);
	...
	Если ОтфильтрованныеМодули = Неопределено Тогда
		...
		ЮТИсполнительСлужебныйКлиент.СохранитьСостояниеТекущегоЭтапаИсполнения(КлючОтфильтрованныеМодули, ОтфильтрованныеМодули);
...
Функция ТестовыеСценарии(ТестовыеМодули, ПараметрыЗапускаТестов)
	...
	Для Каждого ОписаниеМодуля Из ТестовыеМодули Цикл
		...
		Если ПропуститьМодуль Тогда
			Если ОписаниеМодуля.Имя = ОшибочныйМодуль Тогда
				Ошибка = ЮТИсполнительСлужебныйКлиент.ПоследняяОшибкаИсполненения();
