...
Процедура ИнициализироватьКонтекст(Знач ПараметрыЗапуска, Знач ПараметрыДвижка) Экспорт
	
	Контекст = ЮТКонтекстСлужебный.ОписаниеКонтекста(ПараметрыЗапуска, ПараметрыДвижка);
