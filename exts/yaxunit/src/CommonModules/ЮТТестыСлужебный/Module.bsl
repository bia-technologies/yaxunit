...
Процедура СвойствоАлюр(КлючСвойства, ЗначениеСвойства) Экспорт
	
	ТекущийЭлемент = Контекст().ТекущийЭлемент;
	ТекущийЭлемент.СвойстваAllure.Вставить(КлючСвойства, ЗначениеСвойства);
	
КонецПроцедуры

Процедура СвойстваAllure(СтруктураСвойств) Экспорт
	
	ТекущийЭлемент = Контекст().ТекущийЭлемент;
	ЮТКоллекции.ДополнитьСтруктуру(ТекущийЭлемент.СвойстваAllure, СтруктураСвойств);
